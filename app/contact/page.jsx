...
const info = [
    ...
    },
    {
        icon: <FaMapMarkerAlt />,
        title: "Address",
        description: "123 Street, City, State, 12345"
    }
]
                            ...
                            <Select>
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        ...
                                        <SelectItem value="est">Artificial Intelligence/Machine Learning</SelectItem>
                                        <SelectItem value="cst">Mobile Development</SelectItem>
                                        <SelectItem value="mst">Data Processing/Data Engineering</SelectItem>
                                    </SelectGroup>
                                </SelectContent>
                            </Select>
                            {/* Textarea */}
